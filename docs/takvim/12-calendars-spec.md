...
| **BR-CAL-43** | ⚠️ **Paylaşım giriş noktası, sahibin takvim satırında bulunur ve keşfedilebilir olmalıdır.** Yalnızca bir taşma menüsünün içinde saklı kalamaz. ⚠️ **Giriş noktası, takvim paylaşılmamışken de görünür olmalıdır.** Satırdaki paylaşım kontrolü iki durumu tek yerde taşır: paylaşılmamışken **eylem** (*"Paylaş"*), paylaşılmışken **durum** (*"N kişi"*). Her ikisinde de paylaşım yüzeyine götürür. *(1 Eylül 2026'da eklendi; 2 Eylül'de genişletildi — SR-CAL-10.)* |
...
| SR-CAL-10 | Paylaşım nasıl keşfedilir? | **Satırda her zaman görünen paylaşım kontrolü + `⋯` menüsü** (BR-CAL-43/44). Kontrol paylaşılmamışken *"Paylaş"*, paylaşılmışken *"N kişi"* der | ⚠️ İlk düzeltme yalnız **paylaşılmış** takvimlere iz koyuyordu; paylaşılmamış takvimde hâlâ tek yol düşük kontrastlı `⋯` menüsüydü. Yani *"hangileri paylaşılmış"* sorusu çözülmüş, *"nasıl paylaşırım"* sorusu çözülmemişti — kullanıcı ikinciyi soruyordu. Aynı slotun iki durumu taşıması, rail'i kalabalıklaştırmadan ikisini birden çözüyor | Paylaşım yüzeyi vardı ama yalnızca düşük kontrastlı bir `⋯` ikonunun arkasındaydı ve **paylaşılmış olma durumu hiçbir yerde görünmüyordu**. Alıcı tarafı ("Benimle paylaşılanlar") adlandırılmış ve görünürken veren tarafın saklı olması asimetriydi. Alternatif *(başlığa ayrı eylem)* rail'i kalabalıklaştırırdı |
