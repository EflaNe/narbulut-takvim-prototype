...
| **BR-APR-25d** | ⭐ **Doluluk şeridi.** Oda takviminin üstünde kompakt bir **ay görünümü** bulunur: her gün, o güne düşen **kesinleşmiş** ve **bekleyen** kayıtları ayrı işaretlerle gösterir. ⚠️ Doluluk **rezervasyonlardan** okunur — sorumlu, okuma izni olmayan takvimdeki etkinliği görmese de odanın dolu olduğunu görmelidir (`10` BR-PRM-06). Detay maskeleme BR-APR-25b ile aynen geçerlidir. *(SR-APR-14)* |
| **BR-APR-25e** | Şeritte bir güne tıklanınca liste o güne süzülür; geçmiş günler de seçilebilir. ⚠️ Başlıktaki **bekleyen talep rozeti odanın tamamını** temsil eder ve gün filtresiyle **değişmez** — filtrelenmiş bir görünüm "iş kalmadı" izlenimi vermemelidir. |
...
| **BR-APR-29** | ⭐ **Tekrar talep daveti.** Oda sorumlusu, sorumlu olduğu odadaki **reddedilmiş** bir talep için talep edene *"tekrar talep edin"* daveti gönderebilir. |
| **BR-APR-29a** | ⚠️ Davet, **reddi geri almaz** (BR-APR-22 yerinde durur). Talep `Rejected` kalır; kararı veren ve red gerekçesi değişmez. Davet **ayrı bir kayıttır**. Yeni talebi **talep eden** oluşturur — sistem otomatik yeniden talep açmaz. |
| **BR-APR-29b** | ⚠️ **Gerekçe zorunludur** ve talep edene iletilir (N-RES-07). Gerekçesiz davet, talep edene *"neden tekrar denemeliyim"* sorusunu bırakır. |
| **BR-APR-29c** | Bir talebe **bir kez** davet gönderilir; gönderildikten sonra aksiyon yerine **davet kaydı** gösterilir. Talep eden kendi talebine davet gönderemez; sorumlu olmayan kullanıcıya aksiyon **gösterilmez**. |
...
| **V-APR-06** | Davet gerekçesi boş olamaz (BR-APR-29b) | **Engelleyici** |
| **V-APR-07** | Yalnız `Rejected` talebe, yalnız bir kez, yalnız oda sorumlusu davet gönderebilir (BR-APR-29/29c) | **Engelleyici** |
...
| **EC-APR-15** | Davet gönderilmiş talebe tekrar davet denenir | Aksiyon **yoktur** (BR-APR-29c); yerine gönderilen davetin gerekçesi ve göndereni okunur. |
| **EC-APR-16** | Talep eden davete rağmen yeni talep göndermez | Bir şey olmaz. Davet bir **çağrıdır**, talep değildir; sistem kendiliğinden talep açmaz (BR-APR-29a). |
| **EC-APR-17** | Davet gönderildikten sonra slot başkasına verilir | Davet iptal edilmez; talep eden yeni talep gönderirse **karar anında** çakışma görülür (BR-APR-13a). Rakip talep modeli aynen işler. |
...
| SR-APR-13 | Reddedilen karar düzeltilebilir mi? | **Red geri alınmaz; yerine "tekrar talep edin" daveti gönderilir** (BR-APR-29) | D-071 onay yönünü açınca red yönü kapalı kaldı; yönetici kendi hatasını düzeltemiyordu ve talep edenin tekrar denemesi gerektiğini bilmesinin **yolu yoktu**. Reddi doğrudan geri almak, kararı kesin sayan BR-APR-22'yi delerdi ve red kaydını geçmişten silerdi. Davet, D-071 ile aynı kalıbı izler: kararı değiştirmek yerine **yeni bir eylem** — **D-072** |
| SR-APR-14 | "Bu oda hangi günler dolu" sorusu nerede cevaplanır? | **Oda ekranındaki doluluk şeridinde** (BR-APR-25d) | ⚠️ Takvim ızgarası bu soruyu **cevaplayamaz**: orada *okunabilir etkinlikler* gösterilir, *oda doluluğu* değil. Sorumlu, okuma izni olmayan bir takvimdeki etkinliği görmediği için oda dolu olduğu hâlde **boş görünürdü** — planlama için yanıltıcı bir yüzey. Şerit doğrudan rezervasyonlardan okur ve detayı maskeler — **D-073** |
