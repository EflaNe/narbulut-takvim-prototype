...
| **BR-SHELL-45** | Kart **salt okunurdur**: aksiyon, buton veya bağlantı taşımaz. Etkileşim gerektiren her şey etkinlik yüzeyine aittir. |
...
| ID | Kural |
|---|---|
| **BR-SHELL-31** | Sol rail dört filtreleme eksenini barındırır: **tarih navigatörü · takvimler · odalar · diğer filtreler** (`KEEP-03`). ⚠️ **Takvimler ekseni iki bölümdür:** kullanıcının **sahip olduğu** takvimler ve **kendisiyle paylaşılan** takvimler (`12` BR-CAL-16, D-067). |
