 ...
 *
 * ⚠️ **Salt okunurdur, aksiyon taşımaz** (BR-SHELL-45). Etkinlik üzerindeki işlemler
 * sağ tık menüsüne ve drawer'a aittir — bilgi yüzeyi ile aksiyon yüzeyi ayrıdır.
 */
export function EventHoverCard({ event, anchor }: {
  event: CalendarEvent;
  anchor: DOMRect;
}) {
